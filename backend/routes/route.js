...
const { getAllDoctors, bookAppointment, getQueue, advanceAppointment, getAppointmentById, getQueuesSummary } = require('../controller/appointmentController.js');
...
router.get('/management/queues', getQueuesSummary);
